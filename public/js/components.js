...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductItemWrapper = React.createClass({displayName: "ProductItemWrapper",
	    getInitialState: function () {
	        return {data : {}};
	    },
	    render : function () {
	        return React.createElement("label", null, this.props.data.name);
	    }
	});

	var RecipeItemWrapper = React.createClass({displayName: "RecipeItemWrapper",
	    getInitialState: function () {
	        return {
	            data : {
	            products : []
	            ...
	            React.createElement("li", null, 
	                ...
	                React.createElement("div", {className: "products"}, 
	                    this.props.data.products.map(function (product) {
	                        return React.createElement(ProductItemWrapper, {key: product.name, data: product});
	                    })
	                )
	            )
	            );
	...
	var MyRecipes = React.createClass({displayName: "MyRecipes",
	    getInitialState: function () {
	        return {recipes : []};
	    },
	    componentDidMount: function() {
	        ...
	        return (
	            React.createElement("ul", null, 
	                this.state.recipes.map(function (result) {
	                    return React.createElement(RecipeItemWrapper, {key: result._id, data: result});
	                })
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FoodSelection = __webpack_require__(1);
	var MyRecipes = __webpack_require__(161);

	ReactDOM.render((
	  React.createElement(Router, null, 
	    React.createElement(Route, {path: "/", component: FoodSelection}
	    ), 
	    React.createElement(Route, {path: "/recipes", component: MyRecipes}
	    )
	  )
